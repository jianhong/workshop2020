...
```{r, echo=FALSE, fig.cap="library complexity curve"}
importFig(system.file('vignettes', 'libComp.jpg', package = 'workshop2020'), "jpeg")
```
...
```{r, echo=FALSE, fig.cap="metagene"}
importFig(system.file('vignettes', 'heatmap.jpg', package = 'workshop2020'), "jpeg")
```
...
```{r, echo=FALSE, fig.cap="CTCF footprints"}
importFig(system.file('vignettes', 'CtCFfootprints.png', package = 'workshop2020'), "png")
```
...
```{r, echo=FALSE, fig.cap="CTCF vPlot"}
importFig(system.file('vignettes', 'CTCFvPlot.png', package = 'workshop2020'), "png")
```
